...
const processTransfers = async (nft: NftService, latestBlockNo: number, lastCursor: string) => {
...
export const register = async (req: Request, res: Response) => {
  try {
    ...
    const cursor = await processTransfers(nft, latestBlockNo, lastProcessedBlock.lastCursor);
